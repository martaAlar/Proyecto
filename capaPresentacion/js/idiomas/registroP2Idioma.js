document.addEventListener('DOMContentLoaded', function () {
    ...
    var siguiente = document.getElementById("boton");
    ...
    function changeLanguage(lang) {
        ...
        .then(traducciones => {
            ...
            titulo.textContent = idiomaDatos[idiomaSub].registroP2.titulo;
            info.textContent = idiomaDatos[idiomaSub].registroP2.informacion;
            previsualizar.value = idiomaDatos[idiomaSub].registroP2.previsualizar;
            atras.textContent = idiomaDatos[idiomaSub].registroP2.atras;
            siguiente.value = idiomaDatos[idiomaSub].registroP2.siguiente;
        })
        .catch(error => {
            console.log(error)
        })
